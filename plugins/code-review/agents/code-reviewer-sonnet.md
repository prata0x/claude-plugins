...
description: Fast, low-latency diff reviewer for frequent use (e.g. before each commit). Invoked by review skills, not typically triggered directly by user phrasing.
model: sonnet
